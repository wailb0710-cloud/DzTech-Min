      ...
      <header className="bg-[#004d00] text-white pt-8 pb-12 px-4 shadow-lg">
        ...
        {mainSection === 'university' ? (
          ...
          <div className="max-w-6xl mx-auto text-center py-4">
            <h1 className="text-3xl md:text-4xl font-black text-white">قسم المهارات والتوجيه المهني الميداني</h1>
            <p className="text-sm text-green-100 mt-2">طرق سريعة للتمكن من المهن التقنية الأكثر طلباً في سوق العمل مع خرائط طريق من 3 مراحل</p>
          </div>
        )}
      </header>
              ...
              <div className="flex items-center gap-1.5 bg-gray-100 p-1 rounded-xl text-xs font-bold text-gray-700">
                ...
                <button
                  ...
                  className={`px-2.5 py-1 rounded-lg transition-all ${
                    zoomLevel === 'normal' ? 'bg-white text-[#004d00] shadow-sm font-black' : 'hover:bg-gray-200'
                  }`}
                >
                  عادي
                </button>
                <button
                  ...
                  className={`px-2.5 py-1 rounded-lg transition-all ${
                    zoomLevel === 'large' ? 'bg-white text-[#004d00] shadow-sm font-black' : 'hover:bg-gray-200'
                  }`}
                >
                  كبير 🔍
                </button>
                <button
                  ...
                  className={`px-2.5 py-1 rounded-lg transition-all ${
                    zoomLevel === 'xlarge' ? 'bg-white text-[#004d00] shadow-sm font-black' : 'hover:bg-gray-200'
                  }`}
                >
                  ضخم 🔍🔍
                </button>
            ...
            {filteredSpecializations.map((spec, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="px-8 py-5 bg-gray-50/50 border-t border-gray-100 flex flex-wrap justify-between items-center gap-3 group-hover:bg-green-50/30 transition-colors">
                    <button 
                      onClick={() => setZoomedSpec(spec)}
                      className="text-[#004d00] text-sm font-black flex items-center gap-1.5 hover:gap-2.5 transition-all bg-green-50 hover:bg-green-100 px-3.5 py-2 rounded-xl"
                    >
